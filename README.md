...
A quick and silly little bot re-written in Go (originally Python) I created that utilizes services such as vxtwitter, vxtiktok, vxreddit, and ddinstagram in one bot to properly embed media for the user.
